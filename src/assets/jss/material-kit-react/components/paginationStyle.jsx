...
const paginationStyle = {
  ...
  primary: {
    "&,&:hover,&:focus": {
      ...
      color: "#FFFFFF",
      boxShadow:
        "0 4px 5px 0 rgba(20, 121, 251, 0.14), 0 1px 10px 0 rgba(20, 121, 251, 0.12), 0 2px 4px -1px rgba(20, 121, 251, 0.2)",
    },
    "&:hover,&:focus": {
      zIndex: "2",
      cursor: "default",
  ...
  warning: {
    "&,&:hover,&:focus": {
      ...
      color: "#FFFFFF",
      boxShadow:
        "0 4px 5px 0 rgba(254, 212, 1, 0.14), 0 1px 10px 0 rgba(254, 212, 1, 0.12), 0 2px 4px -1px rgba(254, 212, 1, 0.2)",
    },
    "&:hover,&:focus": {
      zIndex: "2",
      cursor: "default",
