...
const buttonStyle = {
  ...
  primary: {
    ...
    "&:hover,&:focus": {
      ...
      //    254, 212, 10 4px 23px 0px rgba(0, 0, 0, 0.12),
      //    0 8px 10px -5px rgba(156, 39, 176, 0.2)",
      boxShadow:
        "0 14px 26px -12px rgba(20, 121, 251, 0.42), 0 4px 23px 0px rgba(0, 0, 0, 0.12), 0 8px 10px -5px rgba(20, 121, 251, 0.2)",
    },
  },
  info: {
  ...
  warning: {
    ...
    "&:hover,&:focus": {
      backgroundColor: warningColor,
      boxShadow:
        "0 14px 26px -12px rgba(254, 212, 1, 0.42), 0 4px 23px 0px rgba(0, 0, 0, 0.12), 0 8px 10px -5px rgba(254, 212, 1, 0.2)",
    },
  },
  danger: {
