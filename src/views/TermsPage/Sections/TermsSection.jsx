        ...
        <GridContainer justify="center">
          <GridItem xs={12}>
            <h2 className={classes.title} style={{ textAlign: "center" }}>
              Welcome to Bezop Marketplace
            </h2>
            <h5>
These terms and conditions outline the rules and regulations for the use of Bezop Marketplace's Website.
            </h5>
            {" "}
            <br />
...
is located at:
            <br />
            <address>
Shop Marketplace, Bezop
              <br />
Bezop - 12334, Bezop
              <br />
            </address>
            <h5>
By accessing this website we assume you accept these terms and conditions in full. Do not continue to use Bezop Marketplace's website
...
The following terminology applies to these Terms and Conditions, Privacy Statement and Disclaimer Notice
	...
	of Bezop. Any use of the above terminology or other words in the singular, plural,
...
Cookies
            ...
            <h5>
We employ the use of cookies. By using Bezop Marketplace's website you consent to the use of cookies
	in accordance with Bezop Marketplace’s privacy policy.
...
License
            ...
            <h5>
Unless otherwise stated, Bezop Marketplace and/or it’s licensors own the intellectual property rights for
	all material on Bezop Marketplace. All intellectual property rights are reserved. You may view and/or print
	pages from http://bezop.com for your own personal use subject to restrictions set in these terms and conditions.
...
You must not:
            ...
            <ol>
              <li>
Republish material from http://bezop.com
              </li>
              <li>
Sell, rent or sub-license material from http://bezop.com
              </li>
              <li>
Reproduce, duplicate or copy material from http://bezop.com
              </li>
            </ol>
            <h5>
Redistribute content from Bezop Marketplace (unless content is specifically made for redistribution).
            </h5>
            <h2>
User Comments
            </h2>
...
Certain parts of this website offer the opportunity for users to post and exchange opinions, information,
		material and data ('Comments') in areas of the website. Bezop Marketplace does not screen, edit, publish
		or review Comments prior to their appearance on the website and Comments do not reflect the views or
		opinions ofBezop Marketplace, its agents or affiliates. Comments reflect the view and opinion of the
		person who posts such view or opinion. To the extent permitted by applicable laws Bezop Marketplaceshall
		...
		website.
              ...
              <li>
Bezop Marketplacereserves the right to monitor all Comments and to remove any Comments which it considers
...
If you are among the organizations listed in paragraph 2 above and are interested in linking to our website,
	you must notify us by sending an e-mail to
              {" "}
              <a href="mailto:policy@bezop.com" title="send an email to policy@bezop.com">
policy@bezop.com
              </a>
.
...
By use of any other description of our Web site or material being linked to that makes sense within the
            ...
            <h5>
No use of Bezop Marketplace’s logo or other artwork will be allowed for linking absent a trademark license
	agreement.
